...
# main funtion we use
    ...
    def plot_sn(self, sig1, sig2, pho1, pho2, noise1, noise2, sn1, sn2):
        ...
        fig.legend(lines_group1, labels_group1, loc='upper right', bbox_to_anchor=(0.95, 0.9))
        ...
        fig.legend(lines_group2, labels_group2, loc='upper right', bbox_to_anchor=(0.95, 0.9))
