...
class ReadRoot():
    def __init__(self):
        self.base_path = "/data/runzezhang/result/TN_sims_D/chunked_root_files_pn_1E7_outside_lead/"
        self.base_path2 = "/data/runzezhang/result/TN_sims_D/chunked_root_files_pn_1E7_outside_lead/"
