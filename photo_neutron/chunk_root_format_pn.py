...
class ReadRoot:
    def __init__(self):
        ...
        self.filepath = self.base_path + "dmx_pn_1E6_outside_x37_lead_gamma.root"
    ...
    def chunk_and_write_root(self, num_chunks=20, output_dir=None):
        if output_dir is None:
            output_dir = os.path.join(self.base_path, "chunked_root_files_pn_1E6_outside_x37_lead_gamma")
