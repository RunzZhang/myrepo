...
# cp /data/runzezhang/Geant4Simulaions/g411_TN/TN_source_AmLi_LZ.mac /data/runzezhang/result/TN_sims_D/chunked_root_files_pn_outside_1E7
...
class ReadRoot:
    def __init__(self):
        ...
        self.filepath = self.base_path + "dmx_pn_1E7_outside_gamma.root"
    ...
    def chunk_and_write_root(self, num_chunks=20, output_dir=None):
        if output_dir is None:
            output_dir = os.path.join(self.base_path, "chunked_root_files_pn_1E7_outside_gamma")
