...
class ReadRoot:
    def __init__(self):
        ...
        self.filepath = self.base_path + "dmx_Co_1173_25E6.root"
    ...
    def chunk_and_write_root(self, start_chunk_cum = 0,num_chunks=20, output_dir=None):
        if output_dir is None:
            output_dir = os.path.join(self.base_path, "chunked_root_files_Co_50E6")
...
if __name__ == "__main__":
    reader = ReadRoot()
    reader.chunk_and_write_root(start_chunk_cum=26,num_chunks=25)