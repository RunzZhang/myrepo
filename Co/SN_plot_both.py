...
class SN():
    def __init__(self, doped=False):
        ...
        self.base_path = "/data/runzezhang/result/GR_sims/chunked_root_files_Co_1E6_normal/"
        self.base_path2 = "/data/runzezhang/result/GR_sims/chunked_root_files_Co_1E6_normal/"
        if self.doped:
