...
class MC_sim_full_argon():
    def __init__(self):
        ...
        self.address = "/data/runzezhang/result/SRIM_MC/MC_argon_full_20231129_6299_2"
        ...
        self.level24909 = [2490.9, 2*0.462 * self.time_factor, {0: [57, 2490.6], 1611.9: [0.5, 878.5]}, self.m_37]
