...
class MC_sim_full_argon():
    def __init__(self):
        ...
        self.address = "/data/runzezhang/result/SRIM_MC/MC_argon_full_20250601_D_ori_new_cut"
    ...
    def data_analysis_v2(self, address):
        ...
        plt.plot(x_bins, hist_result[0], color="blue",label= "dominate branch ori new cut")
