...
class SN():
    def __init__(self,gamma=False,full_gamma = False):
        ...
        self.base_path = "/data/runzezhang/result/TN_sims_D/chunked_root_files_Cf_1E7_test_panel_sourcetube_B/"
        self.base_path2 = "/data/runzezhang/result/TN_sims_D/chunked_root_files_Cf_1E7_test_panel_sourcetube_B/"  # for different density
        # statistics
        # if Cf_1E7, only Cf_1E7_sourcetube_B/A and Cf_1E7_density 104 is 1E6 others are 5E5, sorry for the confusion
...
# main funtion we use
    ...
    def write_sims_results(self):
        ...
        try:#
            ...
            first_argon_ene_array[0] = np.histogram(argon_energy["PreKinetic/keV"],bins=int(max_first_argon/10), range=(0, max_first_argon))
        except:
        ...
        with open(f"/data/runzezhang/result/TN_sims_D/Cf_output_1E7_test_panel_{self.config_string}.pkl", "wb") as f:
