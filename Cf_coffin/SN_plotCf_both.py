...
# main funtion we use
    ...
    def coffin_phys(self):
        ...
        lar_event_list = self.df_phys[(self.df_phys["name"] == "neutron") & (self.df_phys["Volume"].isin(["LAr_phys"]))]["Event"].tolist()
        ...
        self.leaving_coffin_Y_slice = self.leaving_coffin_R[(self.leaving_coffin_R["Y/mm"]>-750)&(self.leaving_coffin_R["Y/mm"]<-650)]
    ...
    def write_sims_results(self):
        ...
        with open(f"/data/runzezhang/result/TN_sims_D/Cf_output_1E7_top_{self.config_string}.pkl", "wb") as f:
