...
class SN():
    def __init__(self,gamma=False,full_gamma = False):
        ...
        self.base_path = "/data/runzezhang/result/TN_sims_D/chunked_root_files_Cf_1E7_zm20_sourcetube_B/"
        self.base_path2 = "/data/runzezhang/result/TN_sims_D/chunked_root_files_Cf_1E7_zm20_sourcetube_B/"  # for different density
        # statistics
...
# main funtion we use
    ...
    def coffin_phys(self):
        ...
        coffin_volume_list = ["cf_active_phys", "cf_source_phys", "block1_phys", "block2_phys", "block3_phys",
   "block4_phys","block5_phys","block6_phys","block7_phys","block8_phys","block9_phys","block10_phys","block11_phys"]
    ...
    def NR_multiplicity(self):
        ...
        for i in range(multiplicity_cut):
            ...
            print(f"multiplicity = {i+1}", energy_th,
                  ratio_t[i],ratio_error_t[i], rate_t[i], rate_error_t[i])
    ...
    def write_sims_results(self):
        ...
        print("last cumulative", cumulative_threshold_per_scatter_array[0][-10:])
        print("last hist", hist_array[0][0][-10:])
        ...
        try:#
            ...
            # 10keV per bin
            max_first_argon = max(self.argon["PreKinetic/MeV"])*1e3
            first_argon_ene_array[0] = np.histogram(argon_energy["PreKinetic/keV"],bins=int(max_first_argon/20), range=(0, max_first_argon))
        except:
        ...
        with open(f"/data/runzezhang/result/TN_sims_D/Cf_output_1E7_zm20_{self.config_string}.pkl", "wb") as f:
