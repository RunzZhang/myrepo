...
class ReadRoot():
    def __init__(self):
        self.base_path = "/data/runzezhang/result/TN_sims_D/chunked_root_files_pn_1E6_outside_x37_lead_full_gamma/"
        self.base_path2 = "/data/runzezhang/result/TN_sims_D/chunked_root_files_pn_1E6_outside_x37_lead_full_gamma/"
    ...
    def main_body(self,i):
        print(i)
        self.ini_path = self.base_path+ f"PN_gamma_1E7_ini_part{i}.csv"
        self.ar_ke_path = self.base_path+ f"PN_gamma_1E7_ke_part{i}.csv"
        self.false_gamma_1 = f"PN_gamma_1E7_false1_part{i}.csv"
        self.false_gamma_2 = f"PN_gamma_1E7_false2_part{i}.csv"
        self.false_gamma_3 = f"PN_gamma_1E7_false3_part{i}.csv"
        self.false_gamma_1_old = f"PN_gamma_1E7_false1_old_part{i}.csv"
        self.false_gamma_2_old = f"PN_gamma_1E7_false2_old_part{i}.csv"
        self.false_gamma_3_old = f"PN_gamma_1E7_false3_old_part{i}.csv"
        self.false_gamma_1_new = f"PN_gamma_1E7_false1_new_part{i}.csv"
        self.false_gamma_2_new = f"PN_gamma_1E7_false2_new_part{i}.csv"
        self.signal = f"PN_gamma_1E7_sig_part{i}.csv"
        self.signal_old = f"PN_gamma_1E7_sig_old_part{i}.csv"
        self.signal_new = f"PN_gamma_1E7_sig_new_part{i}.csv"
        self.false_gamma_1_mid = f"PN_gamma_1E7_false1_mid_part{i}.csv"
        self.false_gamma_2_mid = f"PN_gamma_1E7_false2_mid_part{i}.csv"
        self.false_gamma_3_mid = f"PN_gamma_1E7_false3_mid_part{i}.csv"
        self.signal_mid = f"PN_gamma_1E7_sig_mid_part{i}.csv"
        self.false_gamma_1_old_mid = f"PN_gamma_1E7_false1_old_mid_part{i}.csv"
        self.false_gamma_2_old_mid = f"PN_gamma_1E7_false2_old_mid_part{i}.csv"
        self.false_gamma_3_old_mid = f"PN_gamma_1E7_false3_old_mid_part{i}.csv"
        self.signal_old_mid = f"PN_gamma_1E7_sig_old_mid_part{i}.csv"
        self.false_gamma_1_new_mid = f"PN_gamma_1E7_false1_new_mid_part{i}.csv"
        self.false_gamma_2_new_mid = f"PN_gamma_1E7_false2_new_mid_part{i}.csv"
        self.signal_new_mid = f"PN_gamma_1E7_sig_new_mid_part{i}.csv"
