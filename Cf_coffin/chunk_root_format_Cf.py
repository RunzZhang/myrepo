...
class ReadRoot:
    def __init__(self):
        ...
        self.filepath = self.base_path + "dmx_Cf_1E7_boron10_sourcetube_B.root"
    ...
    def chunk_and_write_root(self, num_chunks=20, output_dir=None):
        if output_dir is None:
            output_dir = os.path.join(self.base_path, "chunked_root_files_Cf_1E7_boron10_sourcetube_B")
