...
# main funtion we use
    ...
    def gamma_rejection_rate_per_keV_vs_Setiz(self):
        ...
        for expfile_name in exp_file_list:
            ...
            #keV
            Q_setiz =[1.3445287166423177, 1.4677096307281403, 1.6077252261931916, 1.7676644948295235, 1.9513368144218666, 2.163478457894038, 2.41003021032974, 2.698514892785409, 3.038557782566206, 3.44261366411884, 3.9269986461894346, 4.513378617028501, 5.230956628311766, 6.119753114689943, 7.235636873731044, 8.658238672578, 10.503756197125261]
            # keV
            E_ion = [0.6935170594033994, 0.7463906266235716, 0.8055756681017613, 0.8721142361762, 0.9472715210586028, 1.0325954589172766, 1.12999567281159, 1.2418491587814853, 1.371143722549567, 1.5216750993325374, 1.6983220883949837, 1.907436620175941, 2.1574068879170554, 2.459486450041476, 2.829041931492084, 3.2874775552634508, 3.865286624630827]
            #g / cc
            rho_l=[1.190713998903872, 1.190901456615719, 1.1910886308789765, 1.1912755227862943, 1.191462133423365, 1.1916484638689993, 1.1918345151951764, 1.192020288467111, 1.192205784743309, 1.1923910050756303, 1.1925759505093436, 1.1927606220831863, 1.1929450208294252, 1.1931291477739037, 1.1933130039361075, 1.193496590329213, 1.1936799079601481]
            #nm
            Rl=[5.609511255785613, 5.807717275806958, 6.020272497298806, 6.248793390358893, 6.495148643090569, 6.761510412830444, 7.050418580730343, 7.364861891716328, 7.70838179881121, 8.085206324999868, 8.500425035138141, 8.960220171784458, 9.472176544801727, 10.0457032178012, 10.69261696165673, 11.427965165560835, 12.271210788702833]
            ...
            for j in range(len(updated_Setiz_list)):
                ...
                threshold_ion = updated_Setiz_list[j]
            ...
            output_dict = {
                ...
                'Eion_rl-1_rhol-1 [10 GeVcm**2 g-1]': updated_Setiz_list,
