...
class SN():
    def __init__(self, doped=False):
        ...
        # self.base_path = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Cs_1E5_ar_inside/"
        # self.base_path2 = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Cs_1E5_ar_inside/"  # for gamma path

        # self.base_path = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Cs_1E6_CF4_inside/"
        # self.base_path2 = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Cs_1E6_CF4_inside/"

        # self.base_path = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Cs_ar_1E6_phot/"
        # self.base_path2 = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Cs_ar_1E6_phot/"

        self.base_path = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Cs_5E6_ER/"
        self.base_path2 = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Cs_5E6_ER/"
        if self.doped:
            self.base_path = self.doped_path

        # self.base_path = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Cs_1E5_lar/"
        # self.base_path2 = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Cs_1E5_lar/"  # for gamma path
    ...
    def data_analysis(self):
        if not self.doped:
            ...
            self.write_doped_sims_results_v2(self.merged_df_phot, bin_start_mev=0, bin_end_mev=0.8,
    ...
    def write_doped_sims_results(self):
        ...
        # output form, rate facotr to mHz, enenrgy edges, counts above the bin edge, counts* counts above the bin edge
        with open("/lzdata/runzezhang/result/GR_sims/Cs_doped_output.pkl", "wb") as f:
            pickle.dump(output_list, f)
