...
class ReadRoot:
    def __init__(self):
        ...
        self.filepath = self.base_path + "dmx_Cs_1E7_100ppm.root"
    ...
    def chunk_and_write_root(self, num_chunks=20, output_dir=None):
        if output_dir is None:
            output_dir = os.path.join(self.base_path, "chunked_root_files_Cs_1E7_100ppm")
...
if __name__ == "__main__":
    reader = ReadRoot()
    reader.chunk_and_write_root(num_chunks=25)