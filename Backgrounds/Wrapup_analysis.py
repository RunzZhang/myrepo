...
class integrated_analysis():
    ...
    def clean_NR_signal_analysis(self):
        ...
        ax[1].plot(self.Cf_simsA[1][0][1][:-1],self.Cf_simsA[0]*self.Cf_simsA[2], labels='Cf confiA spectrum')
        ax[1].plot(self.Cf_simsB[1][0][1][:-1], self.Cf_simsB[0] * self.Cf_simsB[2], labels='Cf confiA spectrum')
