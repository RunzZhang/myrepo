...
class ReadRoot():
    def __init__(self, doped=False):
        ...
        if self.doped:
            self.base_path = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Th_1E8_shell/"
            self.base_path2 = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Th_1E8_shell/"

        # self.base_path = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Th_1E6_normal/"
        # self.base_path2 = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Th_1E6_normal/"
