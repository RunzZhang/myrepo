...
class SN():
    def __init__(self,doped= False):
        ...
        self.doped = doped
        self.doped_path = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Th_1E8_shell/"

        # self.base_path = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Th_1E5_ar_inside/"
        # self.base_path2 = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Th_1E5_ar_inside/"  # for gamma path


        # self.base_path = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Th_1E6_CF4_inside/"
        # self.base_path2 = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Th_1E6_CF4_inside/"

        # self.base_path = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Th_ar_1E6_phot/"
        # self.base_path2 = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Th_ar_1E6_phot/"

        self.base_path = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Th_5E6_ER/"
        self.base_path2 = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Th_5E6_ER/"
        if self.doped:
            self.base_path =  self.doped_path

        # self.base_path = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Th_1E5_lar/"
        # self.base_path2 = "/lzdata/runzezhang/result/GR_sims/chunked_root_files_Th_1E5_lar/"  # for gamma path
...
# main funtion we use
    ...
    def read_ER_Ar_doped(self):
        ...
        ax[0].set_title("Th source")


        plt.savefig(self.plot_path + "Th_1E6_ar_photo.pdf")
    ...
    def read_ER_Ar_pho_per_deposit_rate(self):
        ...
        plt.savefig(self.plot_path + "Th_5E6_ER_perdepostion_photo.pdf")
    ...
    def read_ER_Ar_CF_per_deposit_rate(self):
        ...
        plt.savefig(self.plot_path + "Th_5E6_all_photo.pdf")
    ...
    def read_ER_Ar_CF_per_deposit_rate_cumulative(self):
        ...
        plt.savefig(self.plot_path + "Th_1E7_ER_perdepostion_cumulative.pdf")
    ...
    def write_sims_results_thesis(self, plot=True):
        ...
        if plot:
            ...
            plt.savefig(self.plot_path + "Th_output_spectrum_thesis.pdf")
    ...
    def write_sims_results(self, plot= True):
        ...
        with open("/lzdata/runzezhang/result/GR_sims/Th_output_5E6_ERv2.pkl", "wb") as f:
        ...
        if plot:
            ...
            plt.savefig(self.plot_path + "Th_output_spectrum.pdf")
    ...
    def write_doped_sims_results(self):
        ...
        # output form, rate facotr to mHz, enenrgy edges, counts above the bin edge, counts* counts above the bin edge
        with open("/lzdata/runzezhang/result/GR_sims/Th_doped_output.pkl", "wb") as f:
            pickle.dump(output_list, f)
    ...
    def write_doped_sims_results_v2(self, df, bin_start_mev=0.0, bin_end_mev=1.4, bin_width_mev=0.0001, plot= False):
        ...
        if plot:
            ...
            plt.savefig(self.plot_path +"Th_doped_energy_dep.pdf")
        ...
        if plot:
            ...
            plt.legend()
            plt.yscale("log")
            plt.savefig(self.plot_path+"Th_binding_energy_xe.pdf")
        ...
        cumulative_threshold_array[0] = np.array(
            [sum(energy_deposit_list[i:]) for i in range(len(energy_deposit_list))])
        print("total count* energy Th", cumulative_threshold_per_scatter_array[0][0],
        ...
        # output form, rate facotr to mHz, enenrgy edges, counts above the bin edge, counts* counts above the bin edge
        with open("/lzdata/runzezhang/result/GR_sims/Th_doped_output_full_track.pkl", "wb") as f:
            pickle.dump(output_list, f)
