...
teff_high=np.quantile(teff_min,1-x)
teff_low=np.quantile(teff_min,x)
...
#print (teff_min_median,teff_high,teff_low)
print ("Thresh plot: ",T*(1+teff_min_median/100), " +/- ", ( (teff_high - teff_min_median)+(teff_min_median - teff_low) )*T/200)
#print (TeffM,TeffH,TeffL)
print("#############################################################################")     
...
plt.plot(mean4,efficiencies,linestyle="",marker="o",color="red")
plt.plot(cevns[:,0],cevns[:,1]/cevns[0,1],linestyle=":",marker="",color="black",label="2 GeV WIMP")
plt.fill_between(R,RL,RH,alpha=.15,color="red",label="1-sigma error")
#plt.fill_between(R,RL2,RH2,alpha=.2,color="red") 
#plt.xlim([50,end])
plt.xlim([50,T*2]) 
