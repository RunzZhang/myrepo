...
class ReadRoot():
    ...
    def inelastic_gamma(self):
        ...
        self.gamma_Scint = self.df_gamma_rw[ (self.df['name'] == 'gamma')&(self.df_gamma_rw['Volume'] == 'LAr_phys')&(self.df_gamma_rw['Kinetic/keV'] >0)]
    ...
    def argon_inelastic_gamma(self): # only argon produced inelastic scattering spectrum
        ...
        self.gamma_Scint = self.df_gamma_rw[(self.df_gamma_rw['name'] == 'gamma')&(self.df_gamma_rw['Kinetic/keV'] >0)& (self.df_gamma_rw['Volume'] == 'LAr_phys')& (self.df_gamma_rw['Step ID'] == 1)]
        # >0 to rule out no contribution gammas
        gamma_list = self.gamma_Scint["Event"].unique()
