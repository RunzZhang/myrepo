...
class ReadRoot:
    def __init__(self):
        ...
        self.filepath = self.base_path + "dmx_AmLi_LZ_bare_clean_point_log_1E5_z45_x70.root"
    ...
    def chunk_and_write_root(self, num_chunks=20, output_dir=None):
        if output_dir is None:
            output_dir = os.path.join(self.base_path, "chunked_root_files_AmLi_LZ_bare_clean_point_log_1E5_z45_x70")
