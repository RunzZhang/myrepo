...
class ReadRoot:
    def __init__(self):
        ...
        self.filepath = self.base_path + "dmx_AmLi_LZ_bare_clean_point_log_2E7_z45_x71.root"
    ...
    def chunk_and_write_root(self, num_chunks=20, output_dir=None):
        if output_dir is None:
            output_dir = os.path.join(self.base_path, "chunked_root_files_AmLi_LZ_bare_clean_point_log_2E7_z45_x71")
...
if __name__ == "__main__":
    reader = ReadRoot()
    reader.chunk_and_write_root(num_chunks=10)