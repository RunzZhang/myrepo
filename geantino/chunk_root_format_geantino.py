...
class ReadRoot:
    def __init__(self):
        ...
        self.filepath = self.base_path + "dmx_geantino_1E5.root"
    ...
    def chunk_and_write_root(self, num_chunks=20, output_dir=None):
        if output_dir is None:
            output_dir = os.path.join(self.base_path, "chunked_root_files_geantino_1E5")
        ...
        with uproot.open(self.filepath) as file:
            ...
            for arrays in tree.iterate(expressions=self.selected_columns, library="pd", entry_start=0,
                ...
                chunk_num += 1
                output_filename = os.path.join(output_dir, f"dmx_geantino_1E7_{chunk_num}.root")
