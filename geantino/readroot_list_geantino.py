...
class ReadRoot():
    def __init__(self):
        ...
        self.base_path2 = "/data/runzezhang/result/TN_sims_D/chunked_root_files_geantino_1E5/"
    ...
    def main_body(self,i):
        print(i)
        self.ini_path = self.base_path+ f"geantino_gamma_1E7_ini_part{i}.csv"
        self.ar_ke_path = self.base_path+ f"geantino_gamma_1E7_ke_part{i}.csv"
        self.false_gamma_1 = f"geantino_gamma_1E7_false1_part{i}.csv"
        self.false_gamma_2 = f"geantino_gamma_1E7_false2_part{i}.csv"
        self.false_gamma_3 = f"geantino_gamma_1E7_false3_part{i}.csv"
        self.false_gamma_1_old = f"geantino_gamma_1E7_false1_old_part{i}.csv"
        self.false_gamma_2_old = f"geantino_gamma_1E7_false2_old_part{i}.csv"
        self.false_gamma_3_old = f"geantino_gamma_1E7_false3_old_part{i}.csv"
        self.false_gamma_1_new = f"geantino_gamma_1E7_false1_new_part{i}.csv"
        self.false_gamma_2_new = f"geantino_gamma_1E7_false2_new_part{i}.csv"
        self.signal = f"geantino_gamma_1E7_sig_part{i}.csv"
        self.signal_old = f"geantino_gamma_1E7_sig_old_part{i}.csv"
        self.signal_new = f"geantino_gamma_1E7_sig_new_part{i}.csv"
        self.false_gamma_1_mid = f"geantino_gamma_1E7_false1_mid_part{i}.csv"
        self.false_gamma_2_mid = f"geantino_gamma_1E7_false2_mid_part{i}.csv"
        self.false_gamma_3_mid = f"geantino_gamma_1E7_false3_mid_part{i}.csv"
        self.signal_mid = f"geantino_gamma_1E7_sig_mid_part{i}.csv"
        self.false_gamma_1_old_mid = f"geantino_gamma_1E7_false1_old_mid_part{i}.csv"
        self.false_gamma_2_old_mid = f"geantino_gamma_1E7_false2_old_mid_part{i}.csv"
        self.false_gamma_3_old_mid = f"geantino_gamma_1E7_false3_old_mid_part{i}.csv"
        self.signal_old_mid = f"geantino_gamma_1E7_sig_old_mid_part{i}.csv"
        self.false_gamma_1_new_mid = f"geantino_gamma_1E7_false1_new_mid_part{i}.csv"
        self.false_gamma_2_new_mid = f"geantino_gamma_1E7_false2_new_mid_part{i}.csv"
        self.signal_new_mid = f"geantino_gamma_1E7_sig_new_mid_part{i}.csv"
        ...
        self.filepath = self.base_path + f"dmx_geantino_1E7_{i}.root"
        self.file = uproot.open(self.filepath)["tree"]
        # print("columns: ", self.file.keys())
        # ['Event', 'name', 'Parent ID', 'Track ID', 'Step ID', 'X/mm', 'Y/mm', 'Z/mm', 'Kinetic/MeV', 'Recoiled/MeV', 'Volume', 'Process']
    ...
    def all_tranporation(self):
        # geantino transportaion to find the volume
        self.df["R/mm"] = np.sqrt(self.df["X/mm"]**2+self.df["Y/mm"]**2)
        self.df_boundary = self.df[((self.df['Volume'] == 'LAr_phys')|(self.df['Volume'] == 'hydraulic_fluid_phys')) & (self.df['Parent ID'] == 0)]
        self.df_boundary.to_csv(self.info_path,index= False)
    ...
    def gamma_ER(self):
        ...
        # geantino, just save the total ER in MeV
